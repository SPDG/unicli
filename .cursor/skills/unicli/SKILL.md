...
| Traffic reports | `network traffic internet` (Internet/DPI ranking + site totals), `network traffic wan` (site WAN), `network traffic clients` (LAN-inclusive `stat/report`) |
